                    ...
                    case 'dvd_nuovo':
                        ...
                        if (count($msg) == 0) {
                            ...
                            if (DvdFactory::instance()->nuovo($nuovo) != 1) {
                                $msg[] = '<li> Impossibile creare il brano </li>';
                            }
                        }

                        $this->creaFeedbackUtente($msg, $vd, "Brano creato");
                        ...
                        if (isset($request['dvd'])) {
                            ...
                            if (isset($intVal)) {
                                ...
                                if (DvdFactory::instance()->cancellaPerId($intVal) != 1) {
                                    $msg[] = '<li> Impossibile cancellare il Brano </li>';
                                }


                                $this->creaFeedbackUtente($msg, $vd, "Brano eliminato");
                            }
                        }
                        $dvdi = DvdFactory::instance()->getDvdi();
                        $this->showHomeUtente($vd);
