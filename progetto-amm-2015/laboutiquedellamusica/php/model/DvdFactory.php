...
class DvdFactory {
    ...
    /**
* Restituisce un singleton per creare i brani
...
*/
    ...
    /**
* Restituisce i brani presenti in memoria
* @return array|\Dvd
*/
...
values (?, ?, ?)";
    ...
    /**
* Cancella il brano con per un id specifico
* @param int $id
...
*/
    ...
    /**
* Dato un id viene restituito il brano
